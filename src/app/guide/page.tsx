...
const guideSections: GuideSection[] = [
    ...
    },
    {
        ...
        content: [
            {
                text: "توفر صفحة الفواتير تحليلاً كاملاً لمبيعاتك. يمكنك رؤية إجمالي المبيعات وصافي الأرباح، وتصفية النتائج حسب الموظف لعرض أداء كل فرد في الفريق. يمكنك أيضًا طباعة أي فاتورة سابقة من هنا.",
            },
        ],
    },
    {
