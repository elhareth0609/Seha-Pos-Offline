        ...
        content: [
            {
                ...
                icon: UserPlus,
                text: "عند تشغيل التطبيق لأول مرة، سيُطلب منك إعداد حساب المدير. ستحتاج إلى إدخال اسمك، بريدك الإلكتروني، وتعيين رمز PIN سري مكون من 6 أرقام. هذا الحساب سيكون له صلاحيات كاملة على النظام.",
            },
            {
